          ...
          <div className="flex gap-2 items-center">
            ...
            >
              <svg
                ...
                height="32"
                viewBox="0 0 24 24"
                className="fill-white transition-colors duration-300 group-hover:fill-emerald-400 cursor-pointer"
              >
            ...
            >
              <svg
                ...
                height="32"
                viewBox="0 0 71 72"
                className="fill-white transition-colors duration-300 group-hover:fill-emerald-400"
              >
            ...
            {/* LINKEDIN */}
            <a
              href="https://www.linkedin.com/in/mariana-rodrigues-santana-7b448521b/"
              target="_blank"
              aria-label="Visitar linkedin da psicologa"
              rel="noopener noreferrer"
              className="group flex items-center justify-center transition-all duration-300"
            >
              <svg
                ...
                className="fill-white transition-colors duration-300 group-hover:fill-emerald-400"
              >
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.026-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.049c.477-.9 1.637-1.85 3.367-1.85 3.599 0 4.266 2.369 4.266 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.139.919-2.063 2.063-2.063 1.138 0 2.063.924 2.063 2.063 0 1.139-.925 2.065-2.063 2.065zM7.119 20.452H3.555V9h3.564v11.452z" />
              </svg>
            </a>
          </div>
        </div>
